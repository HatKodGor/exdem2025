...
- **Пример таблицы адресации:**
  ...
  |________________|_________________________|______________|_________|_____________|
  | HQ-RTR         | 172.16.4.1/28           | toISP(ge0)   | ISP_HQ  | 172.16.4.14 |
  |                | 192.168.0.81/29         | vl999        |         |             |
  |                | 192.168.0.62/26         | vl100        |         |             |
  |                | 192.168.1.78/28         | vl200        | HQ_NET  |             |
  |                | 172.16.0.1/30           | GRE          | TUN     |             |
  |________________|_________________________|______________|_________|_____________|
  | HQ-SRV         | 192.168.0.2/26          | ens34        | SRV_NET | 192.168.0.62|
  |________________|_________________________|______________|_________|_____________|
  | HQ-CLI         | 192.168.1.65/28 (DHCP)  | ens34        | CLI_NET | 192.168.1.78|
  |________________|_________________________|______________|_________|_____________|
  | BR-RTR         | 172.16.5.1/28           | toISP(ge0)   | ISP_BR  | 172.16.5.14 |
  |                | 192.168.2.1/27          | toBRS_RV(ge1)| BR_NET  |             |
  |                | 172.16.0.2/30           | GRE          | TUN     |             |
  |________________|_________________________|______________|_________|_____________|
  | BR-SRV         | 192.168.2.2/27          | toBR_RTR     | BR_NET  | 192.168.2.1 |
